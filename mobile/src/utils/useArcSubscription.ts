...
// products — see useCenterPurchases.ts for the other one. No local
// override exists anywhere, for anyone, on any device. Defaults to false
// (the your-arc-preview experience) for a signed-out session or a
// signed-in account with no grant — the same as everyone else until they
// actually have one.
