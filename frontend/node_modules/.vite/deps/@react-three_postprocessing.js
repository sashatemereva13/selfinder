...
} from "./chunk-4XC247DI.js";
import {
  isWebGL2Available
} from "./chunk-ITSPCMXF.js";
import {
  _extends,
  useFrame,
  useLoader,
  useThree
} from "./chunk-CKD7BOO7.js";
import {
  AlwaysDepth,
  BackSide,
  BasicDepthPacking,
  ...
  setVelocityMaterialInScene() {
    ...
    for (const c2 of this.visibleMeshes) {
      ...
      if (originalMaterial !== cachedOriginalMaterial) {
        ...
        if ((_c$skeleton = c2.skeleton) != null && _c$skeleton.boneTexture) this.saveBoneTexture(c2);
  ...
  unsetVelocityMaterialInScene() {
    for (const c2 of this.visibleMeshes) {
      if (c2.material.isVelocityMaterial) {
        ...
        if ((_c$skeleton3 = c2.skeleton) != null && _c$skeleton3.boneTexture) this.saveBoneTexture(c2);
...
var wrapEffect = function(effectImpl, defaultBlendMode) {
  ...
  return (0, import_react.forwardRef)(function Wrap(_ref, ref) {
    ...
    (0, import_react.useLayoutEffect)(() => {
      ...
      if (opacity !== void 0) effect.blendMode.opacity.value = opacity;
      invalidate();
