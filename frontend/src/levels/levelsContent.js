// Single source of truth for every /levels detail page. Each entry pairs the
// listing metadata (name/slug/score) with structured content: short
// "signals" (label/value facts already embedded in the source material) and
// "sections" (headed groups of paragraphs) so the page reads in digestible
// chunks instead of one unbroken wall of prose.
export const LEVELS = [
  {
    slug: "enlightenment",
    name: "enlightenment",
...
export const getLevelBySlug = (slug) => LEVELS.find((level) => level.slug === slug);
